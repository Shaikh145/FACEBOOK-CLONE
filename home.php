            ...
            <div class="create-post">
                <div class="create-post-top">
                    <div class="profile-icon">
                        ...
                        if ($pic_user && $pic_user['profile_picture']) {
                            echo '<img src="' . $pic_user['profile_picture'] . '" alt="Profile Picture">';
                        } else {
                            echo substr($user_name, 0, 1);
                        }
                        ?>
                                    ...
                                    while($comment = $comments_result->fetch_assoc()) {
                                        ...
                                        <div class="comment" id="comment-<?php echo $comment['id']; ?>">
                                            <div class="comment-avatar">
                                                <div class="profile-icon small-icon"><?php echo $profile_pic; ?></div>
                                            </div>
                ...
                if(data.success) {
                    ...
                    if(data.count > 0) {
                        if(likeCount) {
                            ...
                            const statsDiv = document.querySelector(#post-${postId} .post-stats div:first-child);
                            statsDiv.innerHTML = `<i class="fas fa-thumbs-up" style="color: #1877f2;"></i>
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        if(commentCount) {
                            ...
                            const statsDiv = document.querySelector(#post-${postId} .post-stats div:last-child);
                            statsDiv.innerHTML = <span id="comment-count-${postId}">${data.count} comments</span>;
                        }
                    } else {
                        alert('Error: ' + data.message);
                    }
